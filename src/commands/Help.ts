...
export class HelpCommand {
  @Run()
  getHelp(@Worker() worker: WeatherBot) {
    return new Embed()
      .color(COLOR)
      .title('Help with Weather Bot')
      .field(
        'How to use',
        `Simply do /weather to see the weather at the given location and browse it's forecast`
      )
      .field(
        'More Commands',
        [
      ...
      .field(
        'Helpful Links',
        `[Website](https://weather.jpbbots.org) | [Support Server](https://jpbbots.org/support)\n[Top.gg](https://top.gg/bot/${worker.user.id})`
      )
  }
}
